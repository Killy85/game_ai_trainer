    ...
    while flag1:
        for e in event.get():
            ...
            if e.type == KEYDOWN and (e.unicode == 'n' or e.unicode == 'N'):
                global b,j,brs
                b,j,bs,js,brs = initialisation(screen)
                flag2 = True
                while flag2:
                    chrono.tick(120)
                    for e in event.get():
                    ...
                    if j.vies == 0:
                        ...
                        msg5 = cadre.render("Vous avez perdu. Votre score:",
                                            0,black)
